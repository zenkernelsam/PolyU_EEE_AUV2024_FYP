...
static const _DetectionResult_Request_type_support_symbol_names_t _DetectionResult_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, facer_interfaces, srv, DetectionResult_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, facer_interfaces, srv, DetectionResult_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, facer_interfaces, srv, DetectionResult_Request)() {
  return &::facer_interfaces::srv::rosidl_typesupport_c::DetectionResult_Request_message_type_support_handle;
}
...
static const _DetectionResult_Response_type_support_symbol_names_t _DetectionResult_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, facer_interfaces, srv, DetectionResult_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, facer_interfaces, srv, DetectionResult_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, facer_interfaces, srv, DetectionResult_Response)() {
  return &::facer_interfaces::srv::rosidl_typesupport_c::DetectionResult_Response_message_type_support_handle;
}
...
static const _DetectionResult_type_support_symbol_names_t _DetectionResult_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, facer_interfaces, srv, DetectionResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, facer_interfaces, srv, DetectionResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, facer_interfaces, srv, DetectionResult)() {
  return &::facer_interfaces::srv::rosidl_typesupport_c::DetectionResult_service_type_support_handle;
}
