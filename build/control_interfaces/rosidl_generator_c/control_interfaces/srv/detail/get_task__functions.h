...
#ifndef CONTROL_INTERFACES__SRV__DETAIL__GET_TASK__FUNCTIONS_H_
#define CONTROL_INTERFACES__SRV__DETAIL__GET_TASK__FUNCTIONS_H_
...
/// Initialize srv/GetTask message.
/**
...
/// Create srv/GetTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * control_interfaces__srv__GetTask_Request__init().
...
/// Destroy srv/GetTask message.
/**
 * It calls
 * control_interfaces__srv__GetTask_Request__fini()
...
/// Check for srv/GetTask message equality.
/**
...
/// Initialize array of srv/GetTask messages.
/**
...
/// Finalize array of srv/GetTask messages.
/**
 * It calls
 * control_interfaces__srv__GetTask_Request__fini()
...
/// Create array of srv/GetTask messages.
/**
 * It allocates the memory for the array and calls
 * control_interfaces__srv__GetTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetTask messages.
/**
 * It calls
 * control_interfaces__srv__GetTask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetTask message array equality.
/**
...
/// Copy an array of srv/GetTask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * control_interfaces__srv__GetTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_control_interfaces
...
/**
 * It calls
 * control_interfaces__srv__GetTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_control_interfaces
...
/**
 * It allocates the memory for the array and calls
 * control_interfaces__srv__GetTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_control_interfaces
...
/**
 * It calls
 * control_interfaces__srv__GetTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CONTROL_INTERFACES__SRV__DETAIL__GET_TASK__FUNCTIONS_H_
