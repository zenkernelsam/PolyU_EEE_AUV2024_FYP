...
static const _GetTask_Request_type_support_symbol_names_t _GetTask_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, GetTask_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_interfaces, srv, GetTask_Request)),
  }
};
...
{
  return &::control_interfaces::srv::rosidl_typesupport_cpp::GetTask_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_interfaces, srv, GetTask_Request)() {
  return get_message_type_support_handle<control_interfaces::srv::GetTask_Request>();
}
...
static const _GetTask_Response_type_support_symbol_names_t _GetTask_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, GetTask_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_interfaces, srv, GetTask_Response)),
  }
};
...
{
  return &::control_interfaces::srv::rosidl_typesupport_cpp::GetTask_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_interfaces, srv, GetTask_Response)() {
  return get_message_type_support_handle<control_interfaces::srv::GetTask_Response>();
}
...
static const _GetTask_type_support_symbol_names_t _GetTask_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_interfaces, srv, GetTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_interfaces, srv, GetTask)),
  }
};
...
{
  return &::control_interfaces::srv::rosidl_typesupport_cpp::GetTask_service_type_support_handle;
}
