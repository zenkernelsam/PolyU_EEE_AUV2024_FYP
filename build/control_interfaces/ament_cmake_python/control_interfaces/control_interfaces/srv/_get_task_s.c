...
bool control_interfaces__srv__get_task__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("control_interfaces.srv._get_task.GetTask_Request", full_classname_dest, 48) == 0);
  }
  control_interfaces__srv__GetTask_Request * ros_message = _ros_message;
  {  // apply_result
...
{
  /* NOTE(esteve): Call constructor of GetTask_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("control_interfaces.srv._get_task");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTask_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool control_interfaces__srv__get_task__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("control_interfaces.srv._get_task.GetTask_Response", full_classname_dest, 49) == 0);
  }
  control_interfaces__srv__GetTask_Response * ros_message = _ros_message;
  {  // task_name
...
{
  /* NOTE(esteve): Call constructor of GetTask_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("control_interfaces.srv._get_task");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetTask_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
